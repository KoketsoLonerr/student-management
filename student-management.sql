-- Dropping the existing student_management schema if it exists to start fresh.
DROP SCHEMA IF EXISTS student_management CASCADE;
-- Creating the student_management schema if it does not already exist.
CREATE SCHEMA IF NOT EXISTS student_management;

-- Defining the user_login table to store user credentials and basic information.
...
-- Creating the parent_details table to store information about parents/guardians.
...
-- Creating the teachers table to store information about teachers.
...
-- Defining the class_details table to store information about classes.
...
-- Creating the student_details table to store information about students.
...
-- Defining the subject table to store information about subjects.
...
-- Creating the subject_tutors table to associate teachers with subjects and classes.
